    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-grind-line bg-grind-surface p-6">
        ...
        <form action={createUserAction} className="mt-4 grid gap-3 md:grid-cols-2">
          ...
          <input name="role" defaultValue="SuperAdmin" required placeholder="Role" />
          <input name="password" required type="password" placeholder="Password" className="md:col-span-2" />
